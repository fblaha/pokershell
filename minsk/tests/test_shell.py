...
class TestShell(testtools.TestCase):
    ...
    def test_parse_line(self):
        _, player_num = self.shell._parse_line('As 6c Ad 8s Ac 6d 7d')
        self.assertEqual(2, player_num)
        _, player_num = self.shell._parse_line('As 6c Ad 8s Ac 6d 7d 7')
        self.assertEqual(7, player_num)
